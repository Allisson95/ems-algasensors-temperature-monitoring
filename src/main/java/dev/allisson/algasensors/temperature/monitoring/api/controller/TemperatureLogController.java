...
public class TemperatureLogController {
    ...
    @GetMapping
    public ResponseEntity<Page<TemperatureLogOutput>> search(
            @PathVariable TSID sensorId,
            @PageableDefault Pageable pageable) {
        final Page<TemperatureLog> temperatureLogs =
                this.temperatureLogRepository.findAllBySensorId(new SensorId(sensorId), pageable);
